...
namespace SetSolverEngineTests.Services
{
    public partial class SolverServiceTests
    {
        ...
        private static IEnumerable<TestDataSet> TestCases()
        {
            ...
            yield return new TestDataSet([
                new(COLOR.GREEN, SHAPE.CIRCLE, NUM.ONE, SHADING.STRIPED),
            ...
            yield return new TestDataSet([
                ...
                new(COLOR.PURPLE, SHAPE.CIRCLE, NUM.TWO, SHADING.STRIPED),
            ...
            yield return new TestDataSet([
                new(COLOR.GREEN, SHAPE.DIAMOND, NUM.TWO, SHADING.STRIPED),
                new(COLOR.PURPLE, SHAPE.SQUIGGLE, NUM.ONE, SHADING.STRIPED),
                new(COLOR.PURPLE, SHAPE.SQUIGGLE, NUM.TWO, SHADING.STRIPED),
                new(COLOR.GREEN, SHAPE.DIAMOND, NUM.ONE, SHADING.SOLID),
                new(COLOR.RED, SHAPE.SQUIGGLE, NUM.THREE, SHADING.EMPTY),
                new(COLOR.RED, SHAPE.SQUIGGLE, NUM.ONE, SHADING.STRIPED),
                new(COLOR.RED, SHAPE.SQUIGGLE, NUM.THREE, SHADING.SOLID),
                ...
                new(COLOR.GREEN, SHAPE.SQUIGGLE, NUM.TWO, SHADING.STRIPED),
            ...
            yield return new TestDataSet([
                new(COLOR.PURPLE, SHAPE.CIRCLE, NUM.ONE, SHADING.STRIPED),
                new(COLOR.PURPLE, SHAPE.CIRCLE, NUM.ONE, SHADING.SOLID),
                new(COLOR.GREEN, SHAPE.SQUIGGLE, NUM.THREE, SHADING.STRIPED),
                ...
                new(COLOR.RED, SHAPE.DIAMOND, NUM.THREE, SHADING.STRIPED),
                new(COLOR.RED, SHAPE.DIAMOND, NUM.TWO, SHADING.STRIPED),
            ...
            yield return new TestDataSet([
                ...
                new(COLOR.RED, SHAPE.CIRCLE, NUM.ONE, SHADING.STRIPED),
            ...
            yield return new TestDataSet([
                ...
                new(COLOR.RED, SHAPE.DIAMOND, NUM.ONE, SHADING.STRIPED),
                new(COLOR.RED, SHAPE.SQUIGGLE, NUM.TWO, SHADING.SOLID),
                new(COLOR.GREEN, SHAPE.CIRCLE, NUM.TWO, SHADING.STRIPED),
                new(COLOR.PURPLE, SHAPE.DIAMOND, NUM.ONE, SHADING.STRIPED)
            ...
            yield return new TestDataSet([
                ...
                new(COLOR.GREEN, SHAPE.CIRCLE, NUM.THREE, SHADING.STRIPED),
                ...
                new(COLOR.RED, SHAPE.SQUIGGLE, NUM.THREE, SHADING.STRIPED),
                new(COLOR.RED, SHAPE.DIAMOND, NUM.ONE, SHADING.SOLID),
                new(COLOR.RED, SHAPE.SQUIGGLE, NUM.TWO, SHADING.STRIPED),
            ...
            yield return new TestDataSet([
                ...
                new(COLOR.RED, SHAPE.CIRCLE, NUM.TWO, SHADING.STRIPED),
                new(COLOR.GREEN, SHAPE.SQUIGGLE, NUM.ONE, SHADING.EMPTY),
                new(COLOR.GREEN, SHAPE.DIAMOND, NUM.THREE, SHADING.STRIPED),
                new(COLOR.GREEN, SHAPE.SQUIGGLE, NUM.THREE, SHADING.SOLID),
                new(COLOR.RED, SHAPE.CIRCLE, NUM.TWO, SHADING.SOLID),
                new(COLOR.GREEN, SHAPE.DIAMOND, NUM.ONE, SHADING.STRIPED),
                new(COLOR.RED, SHAPE.CIRCLE, NUM.THREE, SHADING.STRIPED),
                new(COLOR.PURPLE, SHAPE.DIAMOND, NUM.TWO, SHADING.STRIPED),
            ...
            yield return new TestDataSet([
                ...
                new(COLOR.RED, SHAPE.CIRCLE, NUM.TWO, SHADING.EMPTY),
                new(COLOR.GREEN, SHAPE.SQUIGGLE, NUM.THREE, SHADING.STRIPED),
                new(COLOR.GREEN, SHAPE.SQUIGGLE, NUM.ONE, SHADING.STRIPED),
                new(COLOR.RED, SHAPE.DIAMOND, NUM.THREE, SHADING.STRIPED),
                new(COLOR.RED, SHAPE.DIAMOND, NUM.ONE, SHADING.SOLID),
                new(COLOR.RED, SHAPE.CIRCLE, NUM.THREE, SHADING.STRIPED),
                new(COLOR.RED, SHAPE.CIRCLE, NUM.ONE, SHADING.STRIPED)
            ...
            // TEST 16: 12 CARDS, 2 SETS (NO "STRIPED" CARDS)
            yield return new TestDataSet([
                new(COLOR.GREEN, SHAPE.SQUIGGLE, NUM.TWO, SHADING.EMPTY),
                new(COLOR.GREEN, SHAPE.CIRCLE, NUM.ONE, SHADING.EMPTY),
                new(COLOR.GREEN, SHAPE.DIAMOND, NUM.THREE, SHADING.SOLID),
            ...
            // TEST 18: 12 CARDS, 2 SETS (NO "SQUIGGLE" OR "STRIPED" CARDS)
            yield return new TestDataSet([
                new(COLOR.GREEN, SHAPE.CIRCLE, NUM.TWO, SHADING.SOLID),
                new(COLOR.GREEN, SHAPE.DIAMOND, NUM.TWO, SHADING.EMPTY),
                new(COLOR.RED, SHAPE.CIRCLE, NUM.ONE, SHADING.EMPTY),
